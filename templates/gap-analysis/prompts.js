...
"quotations": 'This is a subtopic of phrase & section boundaries that is worth handling separately. Are there any issues when dealing with quotations marks, especially when nested? Should block quotes be indented or handled specially? Do quotation marks take text direction into account appropriately?',
...
"abbrev": 'Are there problems with characters or other methods used to indicate abbreviation, ellipsis, or repetition?',
...
"lists": 'The CSS Counter Styles specification describes a limited set of simple and complex styles for counters to be used in list numbering, chapter heading numbering, etc. The rules plus more counter styles (totalling around 120 for over 30 scripts) are listed in the document <a href="https://www.w3.org/TR/predefined-counter-styles/">Ready-made Counter Styles</a>. Do these cover your needs?  Are the details correct (both for counters and separators)? Are there other aspects related to counters and lists that need to be addressed? Are list counters handled correctly in vertical text?',
